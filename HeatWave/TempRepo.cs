...
namespace HeatWave
{
    public class TempRepo
    {
        ...
        {
            new TemperatureMeasurement { Id = 1, InDoorTemperature = 20, OutDoorTemperature = 25, Date = new DateTime(2021, 5, 10, 8, 38, 0) },
            ...
            new TemperatureMeasurement { Id = 5, InDoorTemperature = 10, OutDoorTemperature = -10, Date = new DateTime(2023, 1, 5, 2, 12, 11) }
        };
